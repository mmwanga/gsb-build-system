...
our %desktop =
  (
   ...
   'evolution-data-server'  => '1.5.91',
   'evolution-exchange'     => '2.5.91',
   'evolution-webcal'       => '2.5.90',
   'file-roller'            => '2.13.91',
   'gcalctool'              => '5.7.29',
   'gconf-editor'           => '2.13.90',
   'gdm'                    => '2.13.0.8',
   'gedit'                  => '2.13.91',
   'ggv'                    => '2.12.0',
   'gnome-applets'          => '2.13.4',
   'gnome-backgrounds'      => '2.13.91',
   'gnome-bluetooth'        => '0.7.0',
   'gnome-desktop'          => '2.13.91',
   'gnome-doc-utils'        => '0.5.6',
   'gnome-games'            => '2.13.7',
   ...
   'gnome-nettool'          => '2.13.90',
   'gnome-panel'            => '2.13.91',
   'gnome-phone-manager'    => '0.6',
   'gnome-pilot'            => '2.0.13',
   'gnome-pilot-conduits'   => '2.0.13',
   'gnome-screensaver'      => '2.13.91',
   'gnome-session'          => '2.13.91',
   'gnome-speech'           => '0.3.9',
   'gnome-spell'            => '1.0.7',
