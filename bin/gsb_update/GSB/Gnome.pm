...
our %desktop =
  (
   'alacarte'               => '0.10.1',
   'bug-buddy'              => '2.16.0',
   'control-center'         => '2.16.2',
   'dasher'                 => '4.2.2',
   'eel'                    => '2.16.3',
   'ekiga'                  => '2.0.3',
   'eog'                    => '2.16.2',
   'epiphany'               => '2.16.2',
   'epiphany-extensions'    => '2.16.1',
   'evince'                 => '0.6.1',
   'evolution'              => '2.8.2.1',
   'evolution-data-server'  => '1.8.2',
   'evolution-exchange'     => '2.8.2',
   ...
   'gnome-screensaver'      => '2.16.2',
   'gnome-session'          => '2.16.2',
   'gnome-speech'           => '0.4.6',
   'gnome-spell'            => '1.0.7',
   'gnome-system-monitor'   => '2.16.1',
   'gnome-system-tools'     => '2.15.5',
