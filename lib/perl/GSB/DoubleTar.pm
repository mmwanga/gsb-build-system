...
our %double_tarballs_url =
  (
   ...
   'compiz-fusion'              => {
    ...
    'mozilla-firefox'  => {
    			...
    			'url' => 'http://www.mirrorservice.org/sites/ftp.mozilla.org/pub/mozilla.org/firefox/releases/3.0.5/source',
    			'tar' => 'firefox-3.0.5-source.tar.bz2',
	    		'var' => 'VERSION',
			    },
   'libunique'             => {
			 'ver' => '1.0.4',
 ...
 'Gnome2-Gconf-perl'               => {
   ...
   'webkit'               => {
			 ...
			 'tar' => 'WebKit-r39469.tar.bz2',
			 'var' => 'VERSION',
				  },
    'mozilla-xulrunner'  => {
    			'ver' => '1.9.0.5',
    			'dir' => 'applications/mozilla-xulrunner',
    			'url' => 'http://releases.mozilla.org/pub/mozilla.org/xulrunner/releases/1.9.0.5/source',
    			'tar' => 'xulrunner-1.9.0.5-source.tar.bz2',
	    		'var' => 'VERSION',
			    },
   'gnome-do-plugins' => {
   ...
   'NetworkManager-pptp' => {
            ...
            'tar' => 'NetworkManager-pptp-0.7.0.tar.bz2',
            'var' => 'VERSION',
	           },
   'NetworkManager-openvpn' => {
            ...
            'ver'  => '0.7.0',
            'dir' => 'networking/NetworkManager-vpn',
            'tar' => 'NetworkManager-openvpn-0.7.0.tar.bz2',
            'var' => 'VERSION',
	           },
   'NetworkManager-vpnc' => {
            ...
            'ver'  => '0.7.0',
            'dir' => 'networking/NetworkManager-vpn',
            'tar' => 'NetworkManager-vpnc-0.7.0.tar.bz2',
            'var' => 'VERSION',
	           },
  );
