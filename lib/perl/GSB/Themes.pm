...
our %other_themes =
  (
   'candido-engine'           => {
			     ...
			     #'src' => 'tar.bz2',
			     #},
			     # Pretty buggy at the moment, so ignored.  But seems promising.
			     #'gnomeartng'   => {
			     #'ver' => '0.6.0',
...
our %double_tarballs_themes =
  (
   'candido-themes'            => {
		  ...
		  #},
   'murrine-engine'            => {
             'url' => 'http://ftp.gnome.org/pub/GNOME/sources/murrine/0.90',
             'ver' => '0.90.3',
	     'dir' => 'themes/murrine-engine',
	      'tar' => 'murrine-0.90.3.tar.bz2',
             'var' => 'VERSION',
                  },
		  #'murrine-themes-gtk'            => {
