...
if [ -d etc/gtk-3.0/$(uname -m)-slackware-linux ]; then
  config etc/gtk-3.0/$(uname -m)-slackware-linux/im-multipress.conf.new
  config etc/gtk-3.0/$(uname -m)-slackware-linux/gtkrc.new
elif [ -d etc/gtk-3.0/i486-slackware-linux ]; then
  config etc/gtk-3.0/i486-slackware-linux/im-multipress.conf.new
  config etc/gtk-3.0/i486-slackware-linux/gtkrc.new
elif [ -d etc/gtk-3.0/*-slackware-linux ]; then
  config etc/gtk-3.0/*-slackware-linux/im-multipress.conf.new
  config etc/gtk-3.0/*-slackware-linux/gtkrc.new
fi
