  ...
  <div id="side-bar">
    <div>
      ...
      <ul>
        ...
        <li><a href="/about/" title="About the GSB Project" class=
        "thisPage">About GSB</a></li><?php } else { ?>

        <li><a href="/about/" title="About the GSB Project">About
        GSB</a></li><?php }
            if (strstr($QUERY_STRING, "faqs")) { ?>

        <li><a href="/faqs/" title="Frequently-asked Questions"
        class="thisPage">FAQs</a></li><?php } else { ?>

        <li><a href="/faqs/" title=
        "Frequently-asked Questions">FAQs</a></li><?php }
        ...
        <li><a href="/download/" title="Download" class=
        "thisPage">Download</a></li><?php } else { ?>
        ...
        "thisPage">ChangeLogs</a></li><?php } else { ?>

        <li><a href="/changelog/" title=
        "ChangeLogs">ChangeLogs</a></li><?php }
            if (strstr($QUERY_STRING, "installation")) { ?>

        <li><a href="/installation/" title=
        "Installation Instructions" class=
        "thisPage">Installation</a></li><?php } else { ?>

        <li><a href="/installation/" title=
        "Installation Instructions">Installation</a></li><?php }
        ...
        <li><a href="/support/" title="Support" class=
        "thisPage">Support</a></li><?php } else { ?>

        <li><a href="/support/" title=
        "Support">Support</a></li><?php }
            if (strstr($QUERY_STRING, "links")) { ?>

        <li><a href="/links/" title="Relevant Links" class=
        "thisPage">Links</a></li><?php } else { ?>

        <li><a href="/links/" title=
        "Relevant Links">Links</a></li><?php } ?>

        <li><a href="http://sourceforge.net/projects/gsb" title=
        "SourceForge.net Project Page">Project Page</a></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul>
        <li><a href="http://www.datapipe.net" title=
        "Datapipe graciously provides the official mirror for GSB/FRG packages and ISOs">
        DataPipe Managed Hosting Services</a></li>

        <li><a href=
        "http://sourceforge.net/donate/?group_id=130126" class=
        "imglink"><img src="/images/project-support.jpg" alt=
        "Donate to this project" /></a></li>

        <li><a href="http://sourceforge.net?group_id=130126" title=
        "Project supported by SourceForge.net" class=
